...
└── .claude/
    └── skills/
        └── docx-to-latex.md  # Claude Code skill: convert .docx → LaTeX + YAML
```
...
This repo includes a Claude Code skill for converting Word documents to LaTeX. In Claude Code:
